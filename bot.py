...
def start_web_server() -> None:
    ...
    # A new thread has no event loop by default — create one explicitly,
    # otherwise aiohttp silently fails to start and the whole server dies.
    ...
    logger.info(f"Starting ad-tracking web server on port {port}...")
